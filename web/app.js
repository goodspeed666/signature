...
let PDFViewerApplication = {
  ...
  _readPreferences() {
    ...
    return Promise.all([
      ...
      preferences.get('enablePrintAutoRotate').then(function resolved(
        value) {
  ...
  _initializeViewerComponents() {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.pdfViewer = new PDFViewer({
        ...
        renderInteractiveForms: this.viewerPrefs[
          'renderInteractiveForms'],
        enablePrintAutoRotate: this.viewerPrefs[
    ...
    firstPagePromise.then((pdfPage) => {
      ...
      Promise.all([storePromise, pageModePromise]).then(
        ([values = {}, pageMode]) => {
          ...
          if (values.exists && this.viewerPrefs[
